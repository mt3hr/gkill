<template>
    <v-menu v-model="is_show" :style="context_menu_style">
        <v-list class="gkill_context_menu_list">
            ...
            <v-list-item @click="show_edit_mi_re_kyou_dialog()">
...
import type { MiReKyouContextMenuProps } from './mi-re-kyou-context-menu-props'
import type { KyouViewEmits } from './kyou-view-emits'
import { useMiReKyouContextMenu } from '@/classes/use-mi-re-kyou-context-menu'

const props = defineProps<MiReKyouContextMenuProps>()
...
} = useMiReKyouContextMenu({ props, emits })
