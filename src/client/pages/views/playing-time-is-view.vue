<template>
    ...
    <div class="playing_timeis_view_wrap" ref="playing_timeis_root"
        ...
        <KyouListView :kyou_height="180" :width="timeis_kyou_list_view_width" :list_height="kyou_list_view_height"
            :show_timeis_playing_end_button="true" :application_config="application_config" :gkill_api="gkill_api"
...
import type { PlayingTimeIsViewProps } from './playing-time-is-view-props'
import type { PlayingTimeIsViewEmits } from './playing-time-is-view-emits'
import RykvDialogHost from './rykv-dialog-host.vue'
import { usePlayingTimeIsView } from '@/classes/use-playing-time-is-view'

const props = defineProps<PlayingTimeIsViewProps>()
const emits = defineEmits<PlayingTimeIsViewEmits>()
...
} = usePlayingTimeIsView({ props, emits })
