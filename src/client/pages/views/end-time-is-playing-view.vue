...
import type { EndTimeIsPlayingViewProps } from './end-time-is-playing-view-props'
import type { KyouViewEmits } from './kyou-view-emits'
import KyouView from './kyou-view.vue'
import { VDatePicker } from 'vuetify/components'
import { VTimePicker } from 'vuetify/components'
import { useEndTimeIsPlayingView } from '@/classes/use-end-time-is-playing-view'

const props = defineProps<EndTimeIsPlayingViewProps>()
...
const {
    ...
    // Event relay objects
    crudRelayHandlers,
} = useEndTimeIsPlayingView({ props, emits })
</script>
