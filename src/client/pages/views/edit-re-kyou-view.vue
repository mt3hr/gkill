    ...
    <v-card v-if="cloned_kyou.typed_rekyou" class="pa-2" variant="flat">
        <v-card-title>
            <v-row class="pa-0 ma-0">
                ...
                <v-spacer />
                <v-col cols="auto" class="pa-0 ma-0">
                    <v-checkbox v-model="show_kyou" :readonly="is_busy" :label="i18n.global.t('SHOW_TARGET_KYOU_TITLE')" hide-details color="
                        primary" />
                </v-col>
            </v-row>
        </v-card-title>
        ...
        <v-card v-if="show_kyou">
            <KyouView v-if="cloned_kyou.typed_rekyou" :application_config="application_config" :gkill_api="gkill_api" :is_image_request_to_thumb_size="false"
