<template>
    ...
    <v-card v-if="cloned_kyou.typed_idf_kyou" class="pa-2" variant="flat">
        <v-card-title>
        ...
        <v-card v-if="show_kyou">
            <KyouView v-if="cloned_kyou.typed_idf_kyou" :application_config="application_config" :gkill_api="gkill_api" :is_image_request_to_thumb_size="false"
...
const {
    ...
    // Event relay
    crudRelayHandlers,
} = useEditIDFKyouView({ props, emits })
</script>
