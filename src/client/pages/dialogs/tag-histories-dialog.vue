...
import { useTagHistoriesDialog } from '@/classes/use-tag-histories-dialog'

const props = defineProps<TagHistoriesDialogProps>()
const emits = defineEmits<KyouDialogEmits>()
const { crudRelayHandlers, tag_highlight_targets, is_show_dialog, ui, show_kyou, show, hide } = useTagHistoriesDialog({ props, emits })
