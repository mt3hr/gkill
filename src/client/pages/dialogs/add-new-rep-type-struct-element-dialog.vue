  ...
  <v-checkbox v-model="ui.isTransparent.value" color="white"    size="small" variant="flat" 
      ...
      <div class="gkill-floating-dialog__body">
        ...
        <AddNewRepTypeStructElementView :application_config="application_config" :gkill_api="gkill_api"
          ...
          @requested_add_rep_type_struct_element="(rep_type_struct_element: RepTypeStructElementData) => emits('requested_add_rep_type_struct_element', rep_type_struct_element)" />
        </v-card>
</div>
    </div>
  </Teleport>
...
import { useAddNewRepTypeStructElementDialog } from '@/classes/use-add-new-rep-type-struct-element-dialog'
...
const { is_show_dialog, ui, show, hide } = useAddNewRepTypeStructElementDialog({ props, emits })
