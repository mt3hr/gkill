...
import { useConfirmDeleteTextDialog } from '@/classes/use-confirm-delete-text-dialog'

const props = defineProps<ConfirmDeleteTextDialogProps>()
const emits = defineEmits<KyouDialogEmits>()
const { crudRelayHandlers, is_show_dialog, ui, show, hide } = useConfirmDeleteTextDialog({ props, emits })
