    ...
    <div :ref="ui.containerRef" :style="ui.fixedStyle.value" class="gkill-floating-dialog"
      ...
      <div class="gkill-floating-dialog__body">
        <v-card variant="flat" class="pa-2">
          <EditMiBoardStructView :application_config="application_config" :gkill_api="gkill_api"
            :mi_board_struct="application_config.mi_board_struct"
            @received_errors="(errors: Array<GkillError>) => emits('received_errors', errors)"
            @received_messages="(messages: Array<GkillMessage>) => emits('received_messages', messages)"
            @requested_apply_mi_board_struct="(mi_board_struct_element_data: MiBoardStructElementData) => emits('requested_apply_mi_board_struct', mi_board_struct_element_data)"
