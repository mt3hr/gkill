  ...
  <v-checkbox v-model="ui.isTransparent.value" color="white"    size="small" variant="flat" 
      ...
      <div class="gkill-floating-dialog__body">
        ...
        <ConfirmDeleteNotificationView :application_config="application_config" :gkill_api="gkill_api"
          :highlight_targets="[notification.generate_info_identifier()]" :kyou="kyou"
...
import { useConfirmDeleteNotificationDialog } from '@/classes/use-confirm-delete-notification-dialog'

const props = defineProps<ConfirmDeleteNotificationDialogProps>()
const emits = defineEmits<KyouDialogEmits>()
const { crudRelayHandlers, is_show_dialog, ui, show, hide } = useConfirmDeleteNotificationDialog({ props, emits })
