...
import type { EditPlayingTimeIsDialogProps } from './edit-playing-time-is-dialog-props'
import type { EditPlayingTimeIsDialogEmits } from './edit-playing-time-is-dialog-emits'
import { useEditPlayingTimeIsDialog } from '@/classes/use-edit-playing-time-is-dialog'

const props = defineProps<EditPlayingTimeIsDialogProps>()
const emits = defineEmits<EditPlayingTimeIsDialogEmits>()
const { is_show_dialog, ui, editor_model, is_use_custom_find_kyou_query, show, hide, help_dialog, find_time_is_query_editor_dialog, open_query_editor, onAppliedQuery, onSave, onCancel } = useEditPlayingTimeIsDialog({ props, emits })
