<template>
  ...
  <v-checkbox v-model="ui.isTransparent.value" color="white"    size="small" variant="flat" 
      ...
      <div class="gkill-floating-dialog__body">
        ...
        <EditKmemoView :application_config="application_config" :gkill_api="gkill_api"
...
import { useEditKmemoDialog } from '@/classes/use-edit-kmemo-dialog'

const props = defineProps<EditKmemoDialogProps>()
const emits = defineEmits<KyouDialogEmits>()
const { crudRelayHandlers, is_show_dialog, ui, show, hide } = useEditKmemoDialog({ props, emits })
