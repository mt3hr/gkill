<template>
  ...
  <v-checkbox v-model="ui.isTransparent.value" color="white"    size="small" variant="flat"
      ...
      <div class="gkill-floating-dialog__body">
        ...
        <EditDnoteTrendGraphView :application_config="application_config" :gkill_api="gkill_api"
          :dnote_trend_graph_query="dnote_trend_graph_query"
          @received_errors="(errors: Array<GkillError>) => emits('received_errors', errors)"
          @received_messages="(messages: Array<GkillMessage>) => emits('received_messages', messages)"
          @requested_update_dnote_trend_graph="(dnote_trend_graph_query: DnoteTrendGraphQuery) => emits('requested_update_dnote_trend_graph', dnote_trend_graph_query)"
