...
import AddTimeIsView from '../views/add-time-is-view.vue';
import { i18n } from '@/i18n'
import { useAddTimeIsDialog } from '@/classes/use-add-time-is-dialog'

const props = defineProps<KyouViewDialogProps>()
const emits = defineEmits<KyouDialogEmits>()
const { crudRelayHandlers, is_show_dialog, ui, show, hide } = useAddTimeIsDialog({ props, emits })
