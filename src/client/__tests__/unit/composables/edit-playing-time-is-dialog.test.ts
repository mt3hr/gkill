/**
 * playing検索のカスタム条件ダイアログ（use-edit-playing-time-is-dialog）の検証。
 *
...
function create_dialog() {
    ...
    } as unknown as EditPlayingTimeIsDialogProps
    const emits = (() => { }) as unknown as EditPlayingTimeIsDialogEmits
    return useEditPlayingTimeIsDialog({ props: props, emits: emits })
}
