...
│   ├── api/                 #   GkillAPI クライアント
│   ├── classes/             #   ユーティリティクラス (36ファイル, kyou-view-relay / cascade-delete-kyou / confirm-dialog-close / edit-view-no-update-check / markdown-to-html / mermaid-render / use-dialog-history-stack / delayed-loading / foldable-struct-move / foldable-struct-check / kyou-content-text / use-context-menu-position / use-device-kind / linkify-text / application-config-update-fields-scan / dialog-autofocus / kyou-view-height-source-scan / mi-board-column-layout / use-application-config-view / share-target-dedup 含む)
