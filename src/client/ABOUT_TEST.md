...
Vue 3 フロントエンドのテスト。ユニットテスト（~592テスト）と E2E テスト（187テスト、29ファイル）の合計~779テストで、API クライアント、データモデル、パーサ、Composable、ルーター、i18n、Service Worker、全12ルート + CRUD操作フロー + 設定機能テスト + 回帰テストをカバーする。
