...
import type { RyuuListItemContextMenuEmits } from '@/pages/views/ryuu-list-item-context-menu-emits'
import type EditRyuuItemDialog from '@/pages/dialogs/edit-ryuu-item-dialog.vue'
import type ConfirmDeleteRyuuListItemDialog from '@/pages/dialogs/confirm-delete-ryuu-list-item-dialog.vue'
import type { ModelRef } from 'vue'
import type RelatedKyouQuery from '@/classes/dnote/related-kyou-query'

export function useRyuuListItemContextMenu(options: {
    emits: RyuuListItemContextMenuEmits,
    edit_related_kyou_query_dialog: Ref<InstanceType<typeof EditRyuuItemDialog> | null>,
    confirm_delete_ryuu_list_item_dialog: Ref<InstanceType<typeof ConfirmDeleteRyuuListItemDialog> | null>,
    model_value: ModelRef<RelatedKyouQuery | undefined>,
}) {
    const { emits, edit_related_kyou_query_dialog, confirm_delete_ryuu_list_item_dialog, model_value } = options
