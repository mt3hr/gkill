...
import type { EditTagDialogProps } from '@/pages/dialogs/edit-tag-dialog-props'
import type { KyouDialogEmits } from '@/pages/views/kyou-dialog-emits'
import type { InfoIdentifier } from '@/classes/datas/info-identifier'
import { useDialogHistoryStack } from '@/classes/use-dialog-history-stack'
import { useFloatingDialog } from '@/classes/use-floating-dialog'

export function useEditTagDialog(options: {
    props: EditTagDialogProps
    ...
    const ui = useFloatingDialog("edit-tag-dialog", {
        centerMode: "always",
    })
