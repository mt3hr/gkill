...
export function useEditDeviceStructView(options: {
    ...
    function move_device_struct_up(id: string): void {
        move_struct_up(cloned_application_config.value.device_struct, id)
    }

    function move_device_struct_down(id: string): void {
        move_struct_down(cloned_application_config.value.device_struct, id)
    }

    function show_select_move_target_folder_dialog(id: string): void {
        select_move_target_folder_dialog.value?.show(cloned_application_config.value.device_struct, id)
    }

    function move_device_struct_to_folder(struct_id: string, target_folder_id: string | null): void {
        move_struct_to_folder(cloned_application_config.value.device_struct, struct_id, target_folder_id)
    }
