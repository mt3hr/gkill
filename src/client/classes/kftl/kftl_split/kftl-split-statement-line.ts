...
import { KFTL_ASCII_SPLIT_PREFIX, matches_exact } from '../kftl-prefixes'

export class KFTLSplitStatementLine extends KFTLStatementLine {
    ...
    get_label_name(_context: KFTLStatementLineContext): string {
        return i18n.global.t("KFTL_SPLIT_LABEL_TITLE")
    }

    static is_this_type(line_text: string): boolean {
        return matches_exact(line_text, "KFTL_SPLIT_PREFIX", KFTL_ASCII_SPLIT_PREFIX)
    }
}
