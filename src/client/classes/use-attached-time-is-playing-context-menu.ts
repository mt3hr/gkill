...
import type { AttachedTimeIsPlayingContextMenuProps } from '@/pages/views/attached-time-is-playing-context-menu-props'
...
export function useAttachedTimeIsPlayingContextMenu(options: { props: AttachedTimeIsPlayingContextMenuProps, emits: KyouViewEmits }) {
