...
export function useEditTagStructView(options: {
    ...
    function move_tag_struct_up(id: string): void {
        move_struct_up(cloned_application_config.value.tag_struct, id)
    }

    function move_tag_struct_down(id: string): void {
        move_struct_down(cloned_application_config.value.tag_struct, id)
    }

    function show_select_move_target_folder_dialog(id: string): void {
        select_move_target_folder_dialog.value?.show(cloned_application_config.value.tag_struct, id)
    }

    function move_tag_struct_to_folder(struct_id: string, target_folder_id: string | null): void {
        move_struct_to_folder(cloned_application_config.value.tag_struct, struct_id, target_folder_id)
    }
