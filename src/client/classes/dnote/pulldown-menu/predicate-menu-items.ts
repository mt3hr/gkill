...
export default [
    ...
    { label: i18n.global.t("DNOTE_KC_TITLE_CONTAINS_PREDICATE"), value: "KCTitleContainsPredicate" },
    { label: i18n.global.t("DNOTE_KC_TITLE_EQUAL_PREDICATE"), value: "KCTitleEqualPredicate" },
    { label: i18n.global.t("DNOTE_MI_TITLE_CONTAINS_PREDICATE"), value: "MiTitleContainsPredicate" },
    ...
    { label: i18n.global.t("DNOTE_GIT_COMMIT_LOG_ADDITION_CODE_LESS_THAN_PREDICATE"), value: "GitCommitLogCodeAdditionLessThanPredicate" },
    { label: i18n.global.t("DNOTE_GIT_COMMIT_LOG_DELETION_CODE_GREATER_THAN_PREDICATE"), value: "GitCommitLogCodeDeletionGreaterThanPredicate" },
    ...
    { label: i18n.global.t("DNOTE_EQUAL_TAGS_AND_TARGET_KYOU_PREDICATE"), value: "EqualTagsAndTargetKyouPredicate" },
    { label: i18n.global.t("DNOTE_EQUAL_TAGS_OR_TARGET_KYOU_PREDICATE"), value: "EqualTagsOrTargetKyouPredicate" },
