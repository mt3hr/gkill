...
export default class EqualTagsOrTargetKyouPredicate implements DnotePredicate {
    constructor() { }
    static from_json(_: Record<string, unknown>): DnotePredicate {
        return new EqualTagsOrTargetKyouPredicate()
    }
    ...
    predicate_struct_to_json(): Record<string, unknown> {
        return {
            type: "EqualTagsOrTargetKyouPredicate",
        }
    }
}
