...
import type { KyouViewDialogProps } from '@/pages/dialogs/kyou-view-dialog-props'
...
export function useAddURLogDialog(options: {
    props: KyouViewDialogProps
    ...
    const ui = useFloatingDialog("add-ur-log-dialog", {
        centerMode: "always",
        onEscape: () => hide(),
    })
