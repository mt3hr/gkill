...
import type { EndTimeIsPlayingViewProps } from '@/pages/views/end-time-is-playing-view-props'
...
export function useEndTimeIsPlayingView(options: {
    props: EndTimeIsPlayingViewProps,
    emits: KyouViewEmits,
}) {
