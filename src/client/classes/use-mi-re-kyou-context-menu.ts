...
import type { MiReKyouContextMenuProps } from '@/pages/views/mi-re-kyou-context-menu-props'
import type { KyouViewEmits } from '@/pages/views/kyou-view-emits'

export function useMiReKyouContextMenu(options: {
    props: MiReKyouContextMenuProps,
    emits: KyouViewEmits,
}) {
