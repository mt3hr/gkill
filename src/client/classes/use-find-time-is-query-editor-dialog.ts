...
import type { FindTimeIsQueryEditorDialogProps } from '@/pages/dialogs/find-time-is-query-editor-dialog-props'
import type { FindTimeIsQueryEditorDialogEmits } from '@/pages/dialogs/find-time-is-query-editor-dialog-emits'
import { FindKyouQuery } from '@/classes/api/find_query/find-kyou-query'
import { ApplicationConfig } from '@/classes/datas/config/application-config'
import { close_dialog_via_history, useDialogHistoryStack } from '@/classes/use-dialog-history-stack'
import { useFloatingDialog } from '@/classes/use-floating-dialog'

export function useFindTimeIsQueryEditorDialog(options: {
    props: FindTimeIsQueryEditorDialogProps
    emits: FindTimeIsQueryEditorDialogEmits
    ...
    const ui = useFloatingDialog("find-time-is-query-editor-dialog", {
        centerMode: "always",
    })
