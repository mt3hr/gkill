...
import type { ReKyouContextMenuProps } from '@/pages/views/re-kyou-context-menu-props'
import type { KyouViewEmits } from '@/pages/views/kyou-view-emits'

export function useReKyouContextMenu(options: {
    props: ReKyouContextMenuProps,
    emits: KyouViewEmits,
}) {
