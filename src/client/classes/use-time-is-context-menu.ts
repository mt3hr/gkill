...
import type { TimeIsContextMenuProps } from '@/pages/views/time-is-context-menu-props'
import type { KyouViewEmits } from '@/pages/views/kyou-view-emits'

export function useTimeIsContextMenu(options: {
    props: TimeIsContextMenuProps,
    emits: KyouViewEmits,
}) {
    ...
    async function show_edit_timeis_dialog(): Promise<void> {
        emits('requested_open_rykv_dialog', 'edit_timeis', props.kyou)
    }
