...
import type { LantanaContextMenuProps } from '@/pages/views/lantana-context-menu-props'
import type { KyouViewEmits } from '@/pages/views/kyou-view-emits'

export function useLantanaContextMenu(options: {
    props: LantanaContextMenuProps,
    emits: KyouViewEmits,
}) {
    ...
    async function show_edit_lantana_dialog(): Promise<void> {
        emits('requested_open_rykv_dialog', 'edit_lantana', props.kyou)
    }
