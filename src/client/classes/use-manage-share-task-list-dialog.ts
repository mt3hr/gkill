...
import type { ManageShareKyousLinkDialogEmits } from '@/pages/dialogs/manage-share-task-link-dialog-emits'
import type { ManageShareKyousLinkDialogProps } from '@/pages/dialogs/manage-share-task-link-dialog-props'
import ShareKyousListLinkDialog from '@/pages/dialogs/share-kyou-list-link-dialog.vue'
import ConfirmDeleteShareKyousListDialog from '@/pages/dialogs/confirm-delete-share-kyou-list-dialog.vue'
...
export function useManageShareTaskListDialog(options: {
    props: ManageShareKyousLinkDialogProps
    emits: ManageShareKyousLinkDialogEmits
}) {
    ...
    return {
        ...
        confirm_delete_share_kyou_list_dialog,
        ...
        show,
        hide,
        show_confirm_delete_share_kyou_list_dialog,
        show_share_kyou_list_link_dialog,
        delete_share_kyou_link_info,
        reload_share_kyou_list_infos,
    }
}
