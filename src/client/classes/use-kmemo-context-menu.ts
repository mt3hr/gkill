...
import type { KmemoContextMenuProps } from '@/pages/views/kmemo-context-menu-props'
import type { KyouViewEmits } from '@/pages/views/kyou-view-emits'

export function useKmemoContextMenu(options: {
    props: KmemoContextMenuProps,
    emits: KyouViewEmits,
}) {
    ...
    async function show_edit_kmemo_dialog(): Promise<void> {
        emits('requested_open_rykv_dialog', 'edit_kmemo', props.kyou)
    }
