...
import type { EditRepTypeStructElementDialogEmits } from '@/pages/dialogs/edit-rep-type-struct-element-dialog-emits'
import type { EditRepTypeStructElementDialogProps } from '@/pages/dialogs/edit-rep-type-struct-element-dialog-props'
import { close_dialog_via_history, useDialogHistoryStack } from '@/classes/use-dialog-history-stack'
import { RepTypeStructElementData } from '@/classes/datas/config/rep-type-struct-element-data'
import { useFloatingDialog } from "@/classes/use-floating-dialog"

export function useEditRepTypeStructElementDialog(options: {
    props: EditRepTypeStructElementDialogProps
    emits: EditRepTypeStructElementDialogEmits
}) {
