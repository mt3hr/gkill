...
export class KFTLTimeIsEndTimeStatementLine extends KFTLStatementLine {
    ...
    async apply_this_line_to_request_map(request_map: KFTLRequestMap): Promise<void> {
        let request = request_map.get(this.get_context().get_this_statement_line_target_id()) as unknown as KFTLTimeIsRequest
        if (!request) {
            ...
            request = request_map.get(this.get_context().get_this_statement_line_target_id()) as unknown as KFTLTimeIsRequest
        }
