...
|--------------|---------|----------------|---------------|
| Go バックエンド (`server/`) | 897 | 122 | Go `testing` |
| フロントエンド ユニット (`client/`) | 1850 | 157 | Vitest |
| フロントエンド E2E (`client/`) | 248 | 44 | Playwright |
...
| `server/` | [server/ABOUT_TEST.md](server/ABOUT_TEST.md) | Go バックエンド全体（891テスト / 31パッケージ） |
