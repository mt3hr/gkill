...
|--------------|---------|----------------|---------------|
| Go バックエンド (`server/`) | 1188 | 175 | Go `testing` |
| フロントエンド ユニット (`client/`) | 2038 | 171 | Vitest |
| フロントエンド E2E (`client/`) | 251 | 45 | Playwright |
| MCP サーバ (`mcp/`) | 1015 | 24 | Vitest |
| Android (`android/`) | 15 | 2 | JUnit 4 |
| Wear OS (`wear_os/`) | 200 | 14 | JUnit 4 + MockK |
| **合計** | **4,707** | **431** | |
...
| ディレクトリ | テスト仕様 | 概要 |
|-------------|-----------|------|
| `client/` | [client/ABOUT_TEST.md](client/ABOUT_TEST.md) | フロントエンド全体（unit 2038 + E2E 251） |
...
| `server/` | [server/ABOUT_TEST.md](server/ABOUT_TEST.md) | Go バックエンド全体（1188テスト / 31パッケージ） |
...
| `wear_os/` | [wear_os/ABOUT_TEST.md](wear_os/ABOUT_TEST.md) | Wear OS テスト（200テスト） |
