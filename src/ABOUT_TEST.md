...
|--------------|---------|----------------|---------------|
| Go バックエンド (`server/`) | 975 | 146 | Go `testing` |
| フロントエンド ユニット (`client/`) | 1964 | 166 | Vitest |
| フロントエンド E2E (`client/`) | 251 | 45 | Playwright |
| MCP サーバ (`mcp/`) | 746 | 22 | Vitest |
...
| ディレクトリ | テスト仕様 | 概要 |
|-------------|-----------|------|
| `client/` | [client/ABOUT_TEST.md](client/ABOUT_TEST.md) | フロントエンド全体（unit 1964 + E2E 251） |
...
| `server/` | [server/ABOUT_TEST.md](server/ABOUT_TEST.md) | Go バックエンド全体（975テスト / 31パッケージ） |
...
| `mcp/` | [mcp/ABOUT_TEST.md](mcp/ABOUT_TEST.md) | MCP サーバ（746テスト） |
