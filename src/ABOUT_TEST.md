...
|--------------|---------|----------------|---------------|
| Go バックエンド (`server/`) | 1142 | 169 | Go `testing` |
| フロントエンド ユニット (`client/`) | 1967 | 166 | Vitest |
| フロントエンド E2E (`client/`) | 251 | 45 | Playwright |
| MCP サーバ (`mcp/`) | 939 | 22 | Vitest |
| Android (`android/`) | 15 | 2 | JUnit 4 |
| Wear OS (`wear_os/`) | 181 | 13 | JUnit 4 + MockK |
| **合計** | **4,495** | **417** | |
...
| ディレクトリ | テスト仕様 | 概要 |
|-------------|-----------|------|
| `client/` | [client/ABOUT_TEST.md](client/ABOUT_TEST.md) | フロントエンド全体（unit 1967 + E2E 251） |
...
| `server/` | [server/ABOUT_TEST.md](server/ABOUT_TEST.md) | Go バックエンド全体（1142テスト / 31パッケージ） |
...
| `mcp/` | [mcp/ABOUT_TEST.md](mcp/ABOUT_TEST.md) | MCP サーバ（939テスト） |
| `android/` | [android/ABOUT_TEST.md](android/ABOUT_TEST.md) | Android APK テスト |
| `wear_os/` | [wear_os/ABOUT_TEST.md](wear_os/ABOUT_TEST.md) | Wear OS テスト（177テスト） |
