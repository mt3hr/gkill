...
|--------------|---------|----------------|---------------|
| Go バックエンド (`server/`) | 718 | 82 | Go `testing` |
...
| `server/` | [server/ABOUT_TEST.md](server/ABOUT_TEST.md) | Go バックエンド全体（718テスト / 34パッケージ） |
...
| `server/gkill/dangling/` | [server/gkill/dangling/ABOUT_TEST.md](server/gkill/dangling/ABOUT_TEST.md) | 対象が実在しない付随データの掃除（17テスト） |
| `server/gkill/main/` | [server/gkill/main/ABOUT_TEST.md](server/gkill/main/ABOUT_TEST.md) | CLI エントリポイント |
| `mcp/` | [mcp/ABOUT_TEST.md](mcp/ABOUT_TEST.md) | MCP サーバ（703テスト） |
