...
|--------------|---------|----------------|---------------|
| Go バックエンド (`server/`) | 1400 | 211 | Go `testing` |
| フロントエンド ユニット (`client/`) | 2043 | 182 | Vitest |
| フロントエンド E2E (`client/`) | 254 | 47 | Playwright |
...
| ディレクトリ | テスト仕様 | 概要 |
|-------------|-----------|------|
| `client/` | [client/ABOUT_TEST.md](client/ABOUT_TEST.md) | フロントエンド全体（unit 2043 + E2E 254） |
...
| `server/` | [server/ABOUT_TEST.md](server/ABOUT_TEST.md) | Go バックエンド全体（1400テスト / 33パッケージ） |
