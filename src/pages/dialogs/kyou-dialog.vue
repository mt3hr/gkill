    ...
    <v-dialog :width="'fit-content'" v-model="is_show_dialog" class="kyou_dialog">
        <v-card class="pa-2">
            <KyouView :application_config="application_config" :gkill_api="gkill_api"
                ...
                :show_mi_limit_time="true" :show_timeis_elapsed_time="true" :show_timeis_plaing_end_button="show_timeis_plaing_end_button"
                :height="'100%'" :width="'100%'" :is_readonly_mi_check="is_readonly_mi_check"
                :enable_context_menu="enable_context_menu" :enable_dialog="enable_dialog" :show_attached_timeis="true"
                :show_rep_name="true" :force_show_latest_kyou_info="false" :show_update_time="false"
