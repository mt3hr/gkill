...
import type { ShareKyousListViewEmits } from './share-task-list-view-emits'
import type { ShareKyousListViewProps } from './share-task-list-view-props'
...
async function share(): Promise<void> {
    ...
    share_kyou_list_info.is_share_detail = !share_time_only.value
