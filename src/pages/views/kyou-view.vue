<template>
    <AttachedTag v-for="attached_tag, index in cloned_kyou.attached_tags" />
    <AttachedText v-for="attached_text, index in cloned_kyou.attached_texts" />
...
import MiView from './mi-view.vue';
