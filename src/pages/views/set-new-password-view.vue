...
const password_reset_token: Ref<string> = ref("")
...
async function try_set_new_password(password_reset_token: string, user_id: string, password_sha_256: string): Promise<boolean> {
