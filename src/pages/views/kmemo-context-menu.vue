<template>
    ...
    <EditKmemoDialog :application_config="application_config" :gkill_api="gkill_api"
...
const edit_kmemo_dialog = ref<InstanceType<typeof EditKmemoDialog> | null>(null);
...
async function show_edit_kmemo_dialog(): Promise<void> {
    edit_kmemo_dialog.value?.show()
}
