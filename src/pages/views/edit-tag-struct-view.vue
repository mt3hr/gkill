<template>
    <TagStructElement />
    <AddNewTagStructElementDialog />
    <EditTagStructElementDialog />
</template>
...
const tag_struct: Ref<TagStruct> = ref(await props.tag_struct.clone());
const tag_struct_root: Ref<TagStruct> = ref(await props.tag_struct_root.clone());
</script>
