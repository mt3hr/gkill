<template>
    <ConfirmDeleteShareTaskListDialog />
    <KyouCountCalendar />
    <KyouView />
    <ManageShareTaskListDialog />
    <ShareTaskListDialog />
    <ShareTaskListLinkDialog />
    <MiBoardTaskListView v-for="find_mi_query, index in find_mi_queries" />
    <miQueryEditorSidebar />
    <miShareFooter />
</template>
