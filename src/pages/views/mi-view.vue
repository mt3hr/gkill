                    ...
                    <td valign="top" v-for="query, index in querys" :key="query.query_id"
                        ...
                        <v-card>
                            ...
                            <KyouListView :kyou_height="56 + 35" :width="400"
                                ...
                                :show_rep_name="false" :force_show_latest_kyou_info="false" :show_content_only="false"
                                ...
                                @deleted_kyou="(deleted_kyou) => { reload_list(index); reload_kyou(deleted_kyou); focused_kyou?.reload(true, true) }"
