<template>
    <EditTimeIsDialog :application_config="application_config" :gkill_api="gkill_api" :highlight_targets="[]"
        :kyou="kyou" :timeis="props.kyou.typed_timeis" :last_added_tag="last_added_tag"
