<template>
    <KyouView v-for="kyou, index in match_kyous" :application_config="application_config" :gkill_api="gkill_api"
        :highlight_targets="[]" :is_image_view="false" :kyou="kyou" :last_added_tag="last_added_tag"
