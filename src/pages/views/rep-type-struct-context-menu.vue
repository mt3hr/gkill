...
const context_menu_style = computed(() => `{ position: absolute; left: ${Math.min(document.defaultView!.innerWidth - 130, position_x.value.valueOf())}px; top: ${document.defaultView!.innerHeight - 400, position_y.value.valueOf()}px; }`)
