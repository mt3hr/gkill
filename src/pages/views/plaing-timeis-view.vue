<template>
    <div class="plaing_timeis_view_wrap">
        <KyouListView :kyou_height="180" :width="app_content_width.valueOf() - 8" :list_height="kyou_list_view_height"
            ...
            @deleted_kyou="reload_list(false)" @received_errors="(...errors :any[]) => emits('received_errors', errors[0] as Array<GkillError>)"
            @received_messages="(...messages :any[]) => emits('received_messages', messages[0] as Array<GkillMessage>)"
            @requested_reload_kyou="reload_list(false)" @requested_reload_list="reload_list(false)"
            @requested_search="search(false)" @deleted_tag="(...deleted_tag: any[]) => { }" @deleted_text="(...deleted_text :any[]) => { }"
            @deleted_notification="(...deleted_notification :any[]) => { }" @registered_tag="(...registered_tag :any[]) => { }"
            @registered_text="(...registered_text: any[]) => { }" @registered_notification="(...registered_notification: any[]) => { }"
            @updated_tag="(...updated_tag :any[]) => { }" @updated_text="(...updated_text: any[]) => { }"
            @updated_notification="(...updated_notification :any[]) => { }" ref="kyou_list_views" />
        <AddKCDialog :application_config="application_config" :gkill_api="gkill_api" :highlight_targets="[]"
            ...
            @received_messages="(...messages :any[]) => emits('received_messages', messages[0] as Array<GkillMessage>)" ref="add_kc_dialog" />
        <AddTimeisDialog :application_config="application_config" :gkill_api="gkill_api" :highlight_targets="[]"
            ...
            :enable_dialog="enable_dialog" @received_errors="(...errors :any[]) => emits('received_errors', errors[0] as Array<GkillError>)"
            @deleted_kyou="(...deleted_kyou :any[]) => { reload_kyou(deleted_kyou[0]); focused_kyou?.reload(true, true) }"
            @deleted_text="(...deleted_text :any[]) => { }" @deleted_notification="(...deleted_notification :any[]) => { }"
            @registered_kyou="(...registered_kyou :any[]) => { }" @registered_tag="(...registered_tag :any[]) => { }"
            @registered_text="(...registered_text: any[]) => { }" @registered_notification="(...registered_notification: any[]) => { }"
        ...
        <kftlDialog :application_config="application_config" :gkill_api="gkill_api" :highlight_targets="[]"
            ...
            :app_content_width="app_content_width" @received_errors="(...errors :any[]) => emits('received_errors', errors[0] as Array<GkillError>)"
        ...
        <UploadFileDialog :app_content_height="app_content_height" :app_content_width="app_content_width"
            ...
            @received_messages="(...messages :any[]) => emits('received_messages', messages[0] as Array<GkillMessage>)" ref="upload_file_dialog" />
