    ...
    <div class="plaing_timeis_view_wrap">
        ...
        <v-main class="main">
            ...
            <PlaingTimeisView :application_config="application_config" :gkill_api="gkill_api"
                ...
                @received_errors="(...errors :any[]) => write_errors(errors[0] as Array<GkillError>)" @received_messages="(...messages :any[]) => write_messages(messages[0] as Array<GkillMessage>)" ref="plaing_timeis_view" />
