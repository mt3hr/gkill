...
└── gkill/
    ...
    │   ├── gkill_server_api/  # HTTP ハンドラ（109 handle_*.go + 認証・ルーティング）
...
- [api/README.md](gkill/api/README.md) — HTTP API 共通基盤・ハンドラ層（全91エンドポイント一覧）
- [api/gkill_server_api/README.md](gkill/api/gkill_server_api/README.md) — HTTP ハンドラ（151ファイル）
