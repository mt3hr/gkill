...
CREATE TABLE IF NOT EXISTS "TEXT" (
  ...
  TX_ID NOT NULL
	...
	// ID先頭の既存索引では効かない。
	if err := sqlite3impl.EnsureTxIDIndex(ctx, db, "TEXT"); err != nil {
		return nil, err
	}
...
func (t *textTempRepositorySQLite3Impl) GetLatestDataRepositoryAddress(ctx context.Context, updateCache bool) ([]gkill_cache.LatestDataRepositoryAddress, error) {
	return nil, fmt.Errorf("not implements textTempRepositorySQLite3Impl.GetLatestDataRepositoryAddress")
}
