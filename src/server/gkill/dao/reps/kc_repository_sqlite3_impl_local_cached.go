...
func NewKCRepositorySQLite3ImplLocalCached(ctx context.Context, userID string, filename string, fullConnect bool) (KCRepository, error) {
...
func (k *kcRepositorySQLite3ImplLocalCached) UpdateCache(ctx context.Context) error {
	...
	if err = os.Remove(k.localCacheDBFileName); err != nil && !os.IsNotExist(err) {
		...
		k.skipRebuild = true
		reopenedRep, reopenErr := NewKCRepositorySQLite3Impl(ctx, k.localCacheDBFileName, k.fullConnect)
		if reopenErr != nil {
...
func (k *kcRepositorySQLite3ImplLocalCached) LastUpdateCacheChanged() bool {
...
func (k *kcRepositorySQLite3ImplLocalCached) CommitCacheRebuild() {
...
func (k *kcRepositorySQLite3ImplLocalCached) GetLatestDataRepositoryAddress(ctx context.Context, updateCache bool) ([]gkill_cache.LatestDataRepositoryAddress, error) {
