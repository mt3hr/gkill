...
GROUP BY DEVICE
`
	gkill_log.LogSQL(ctx, checkEnableDeviceCountSQL)
	...
	gkill_log.LogSQLQuery(ctx, checkEnableDeviceCountSQL, queryArgs)
...
`
	...
	gkill_log.LogSQLQuery(ctx, checkEnableDeviceCountSQL, queryArgsCheckEnableDevice)
