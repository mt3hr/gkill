...
func TestAPIRoutes_AuthKindGolden(t *testing.T) {
	...
	golden := map[string]kind{
		...
		"/api/upload_skill":                      {authNone, bodyUpload},
		...
		"/api/get_skill_list":                    {authSession, bodyNone},
		"/api/get_skill":                         {authSession, bodyNone},
		"/api/download_skill":                    {authSession, bodyNone},
		"/api/write_skill_file":                  {authSession, bodyNone},
		"/api/delete_skill":                      {authSession, bodyNone},
