...
| `error_codes.go` | エラーコード定数（377 定数: `ERR000001` 〜 `ERR000418`、欠番 41。うち 37 は存在しないエンドポイント（`get_gkill_info` / `get_kftl_template` / `update_*_struct` 等）のコードを 2026-09-14 に削除した跡。ADR-0709） |
