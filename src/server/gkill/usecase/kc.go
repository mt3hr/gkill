...
func (uc *UsecaseContext) AddKC(ctx context.Context, repositories *reps.GkillRepositories, userID, device, localeName string, kc reps.KC, txID *string) ([]*message.GkillError, error) {
	...
	if err != nil {
		...
		slog.Log(ctx, gkill_log.Debug, "error at get kc user id", "error", fmt.Sprintf("%q", err))
	...
	if existKC != nil {
		...
		slog.Log(ctx, gkill_log.Debug, "exist kc id", "error", fmt.Sprintf("%q", err))
		gkillErrors = append(gkillErrors, &message.GkillError{
	...
	if txID == nil {
		...
		if err != nil {
			...
			slog.Log(ctx, gkill_log.Debug, "error at add kc user id", "error", fmt.Sprintf("%q", err))
			gkillErrors = append(gkillErrors, &message.GkillError{
...
func (uc *UsecaseContext) UpdateKC(ctx context.Context, repositories *reps.GkillRepositories, userID, device, localeName string, kc reps.KC, txID *string) ([]*message.GkillError, error) {
	...
	if existKC == nil {
		...
		slog.Log(ctx, gkill_log.Debug, "not exist kc id", "error", fmt.Sprintf("%q", err))
		gkillErrors = append(gkillErrors, &message.GkillError{
	...
	if txID == nil {
		...
		if err != nil {
			...
			slog.Log(ctx, gkill_log.Debug, "error at update kc user id", "error", fmt.Sprintf("%q", err))
			gkillErrors = append(gkillErrors, &message.GkillError{
