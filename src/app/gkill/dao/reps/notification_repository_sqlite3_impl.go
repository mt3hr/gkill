...
func (t *notificationRepositorySQLite3Impl) GetLatestDataRepositoryAddress(ctx context.Context, updateCache bool) ([]*gkill_cache.LatestDataRepositoryAddress, error) {
	dbName := "NOTIFICATION"
	var err error
	var db *sql.DB
	if t.fullConnect {
