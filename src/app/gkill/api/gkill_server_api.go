...
func (g *GkillServerAPI) HandleGetHistoriesByTagID(w http.ResponseWriter, r *http.Request) {
	// ˅
	panic("notImplements")
	// ˄
}
...
func (g *GkillServerAPI) HandleGetHistoriesByTextID(w http.ResponseWriter, r *http.Request) {
	// ˅
	panic("notImplements")
	// ˄
}
...
func (g *GkillServerAPI) HandleKFTLTemplate(w http.ResponseWriter, r *http.Request) {
	// ˅
	panic("notImplements")
	// ˄
}
