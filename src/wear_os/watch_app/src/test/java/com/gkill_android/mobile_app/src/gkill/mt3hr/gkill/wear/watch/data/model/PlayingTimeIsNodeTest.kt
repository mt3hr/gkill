...
/**
 * Unit tests for PlayingTimeIsNode serialization/deserialization using kotlinx.serialization.
 */
class PlayingTimeIsNodeTest {
    ...
    fun deserialize_fullNode() {
        ...
        val node = json.decodeFromString<PlayingTimeIsNode>(jsonStr)
    ...
    fun serialize_fullNode() {
        ...
        val jsonStr = json.encodeToString(PlayingTimeIsNode.serializer(), node)
    ...
    fun roundTrip_preservesAllFields() {
        val original = PlayingTimeIsNode(
            id = "roundtrip-001",
            rep_name = "rt_repo",
        ...
        val jsonStr = json.encodeToString(PlayingTimeIsNode.serializer(), original)
        val deserialized = json.decodeFromString<PlayingTimeIsNode>(jsonStr)
    ...
    fun equals_sameValues_areEqual() {
        val node1 = PlayingTimeIsNode(id = "eq-001", title = "Same")
        val node2 = PlayingTimeIsNode(id = "eq-001", title = "Same")
        assertEquals(node1, node2)
    }

    @Test
    fun equals_differentValues_areNotEqual() {
        val node1 = PlayingTimeIsNode(id = "eq-001", title = "One")
        val node2 = PlayingTimeIsNode(id = "eq-002", title = "Two")
        assertNotEquals(node1, node2)
    }

    @Test
    fun hashCode_sameValues_areEqual() {
        val node1 = PlayingTimeIsNode(id = "hc-001", title = "Hash")
        val node2 = PlayingTimeIsNode(id = "hc-001", title = "Hash")
