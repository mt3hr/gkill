...
// documents/adr/0306-codex-thread-id-from-filename.md
...
const (
	...
	// その直後に来る(大半の行)ので、512もあれば桁で足りる。
	headScanBytes = 512

	// maxRecordBytes は保持する1レコードの上限。
	// 実データで保持対象の最大行は数百KBなので8倍の余裕がある。
