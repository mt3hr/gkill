...
│   └── reps/                          ← リポジトリ実装（60ファイル。repositories_get_kyou_histories_cache_test.go, plugin_repository_impl_test.go, git_commit_log_cached_unique_test.go, ur_log_fill_skip_test.go 等）
