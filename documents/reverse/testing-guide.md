...
|--------------|---------|----------------|---------------|
| Go バックエンド | 834 | 102 | Go `testing` |
| フロントエンド ユニット | 1360 | 128 | Vitest |
...
│   └── reps/                          ← リポジトリ実装（36ファイル。plugin_repository_impl_test.go, mi_re_kyou_repository_sqlite3_impl_test.go, re_kyou_granular_cache_test.go 等）
