...
|--------------|---------|----------------|---------------|
| Go バックエンド | 847 | 105 | Go `testing` |
| フロントエンド ユニット | 1542 | 141 | Vitest |
| フロントエンド E2E | 228 | 42（+auth.setup.ts） | Playwright |
...
│   ├── kftl/                          ← KFTL パーサ（5ファイル）
│   ├── composables/                   ← Vue Composable（48ファイル。add-views / edit-views /
