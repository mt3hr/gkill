...
│   └── reps/                          ← リポジトリ実装（50ファイル。plugin_repository_impl_test.go, git_commit_log_cached_unique_test.go, gps_log_repositories_test.go 等）
