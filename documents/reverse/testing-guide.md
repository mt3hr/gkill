...
|--------------|---------|----------------|---------------|
| Go バックエンド | 867 | 106 | Go `testing` |
| フロントエンド ユニット | 1674 | 144 | Vitest |
| フロントエンド E2E | 230 | 42（+auth.setup.ts） | Playwright |
...
│   ├── kftl/                          ← KFTL パーサ（5ファイル）
│   ├── composables/                   ← Vue Composable（49ファイル。add-views / edit-views /
