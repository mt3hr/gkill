...
15. **[api-endpoints.md](api-endpoints.md)** — APIエンドポイント一覧。全93エンドポイント（登録済み91）のリファレンスです。
...
| [usecase.md](usecase.md) | ユースケース一覧（87件） | 機能仕様の把握、テスト設計 |
...
| [api-endpoints.md](api-endpoints.md) | 全APIエンドポイントのリファレンス（93件定義・91件登録） | API利用・実装時の参照 |
