# ADR-0703: 共有ページのファイル配信は共有クエリを再評価した許可パス集合にだけ許す

| | |
|---|---|
| Status | Accepted |
| Date | 2026-08-21 |
| Sources | `bb364253`（指摘 C-03） / `.claude/skills/gkill-go-backend/SKILL.md`「共有ページのファイル配信は共有クエリの結果に含まれるファイルだけ」節 |
| Supersedes | なし |
| Superseded-by | なし |
