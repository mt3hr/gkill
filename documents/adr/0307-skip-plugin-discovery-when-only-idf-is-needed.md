# ADR-0307: IDF のリポジトリしか要らない経路ではプラグインを探索しない
...
派生キャッシュの生成そのものを速くしたあと（[ADR-0211](0211-expand-rep-patterns-without-walking.md) / [ADR-0212](0212-derived-cache-scan-lists-directories.md)）、残った所要時間の大半がこの探索だった。プラグインを複数入れている利用者ほど不利になる。
