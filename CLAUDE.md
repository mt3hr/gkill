...
**Test coverage (~1,872+ tests total, all 29 Go packages covered):**
...
- `testing-guide.md` — Test execution, architecture, and guidelines (~1,658 tests)
